...
export const CardStack = ({ items }: { items: Card[] }) => {
  ...
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center">
      <div className="absolute max-w-[1200px] top-0 my-10 h-2 rounded-full bg-[#DBE4FF] w-[90vw]">
        {/* Progressive Bar */}
        <div
      ...
      <div className="flex w-4/5 md:w-[700px] flex-col items-center justify-center space-y-10">
        <Slider
          min={0}
          max={10}
          value={value}
      ...
      <button
        onClick={handleNext}
        className="my-10 h-12 w-4/5 md:w-[700px] rounded-xl bg-[#1A3199]"
      >
